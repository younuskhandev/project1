...
@media (max-width: 767px) {
	...
	.notice.bp-add-group-types-notice .bp-add-group-types-notice-inner .no-thanks {
		...
		public function set_no_bug() {
			...
			if ( ! isset( $_GET['_wpnonce'] ) || ( ! wp_verify_nonce( $_GET['_wpnonce'], 'bp-add-group-types-feedback-nounce' ) || ! is_admin() || ! isset( $_GET[ $this->nobug_option ] ) || ! current_user_can( 'manage_options' ) ) ) {
				return;
			}
